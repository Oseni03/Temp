        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid gap-8 md:grid-cols-6">
                ...
                <div className="md:col-span-2 space-y-8">
                    <Card className="border-border/50 shadow-md bg-linear-to-br from-primary/10 via-background to-background backdrop-blur-md ring-1 ring-primary/20 overflow-hidden group">
                        <CardHeader className="pb-4">
                            <CardTitle className="text-lg font-bold">Account Security</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="p-4 rounded-xl bg-background/60 border border-primary/10 shadow-inner group-hover:border-primary/30 transition-colors">
                                <p className="text-sm font-bold text-primary flex items-center gap-2">
                                    <ShieldCheck className="h-4 w-4" />
                                    Two-Factor Auth
                                </p>
                                <p className="text-xs text-muted-foreground mt-2 leading-relaxed font-medium">
                                    Enhance security by requiring a code from your mobile device.
                                </p>
                                <Button variant="outline" size="sm" className="mt-4 w-full border-primary/20 bg-background/40 text-primary hover:bg-primary/5 font-semibold" disabled>
                                    Setup 2FA
                                </Button>
                            </div>
                            ...
                            <div className="pt-4 flex flex-col gap-3">
                                <div className="flex items-center gap-3 px-1">
                                    ...
                                    <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-widest">Sessions Active</span>
                                </div>
                                <p className="text-xs px-1 text-muted-foreground/80 font-medium">
