...
const testimonial = {
    quote:
        "TempTrap cut our fake account signups by 94% in the first week. It just works — no config, no fuss.",
    author: "Sarah K.",
                ...
                <div className="relative z-10 space-y-10">
                    <div className="space-y-3">
                        ...
                        <h1 className="text-4xl font-bold tracking-tight text-background leading-[1.15]">
                            Start verifying<br />in minutes.<br />Free forever.
                        </h1>
                        <p className="text-base text-background/60 font-light max-w-xs leading-relaxed">
                            No credit card required. 1,000 free checks per month.
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        {stats.map((s) => (
                            <div key={s.label} className="space-y-1">
                                ...
                                <p className="text-2xl font-bold text-background tracking-tight">{s.value}</p>
                                <p className="text-[10px] font-medium text-background/40 uppercase tracking-wider">{s.label}</p>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="p-5 rounded-2xl bg-background/5 border border-background/10 space-y-3">
                        ...
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                <p className="text-xs font-semibold text-background">{testimonial.author}</p>
                                <p className="text-[10px] text-background/40 font-light">{testimonial.role}</p>
                            </div>
                        </div>
                    </div>
                </div>
