...
const features = [
	{
		...
		description:
			"Real-time disposable email identification with 99.9% accuracy.",
	},
	{
		icon: Zap,
		title: "Sub-100ms Response",
		description:
			"Lightning-fast API responses that never slow your signup flow.",
	},
	{
		icon: Lock,
		title: "Enterprise Security",
		description:
			"SOC 2 compliant with end-to-end encrypted API communication.",
	},
];
				...
				<div className="relative z-10 space-y-8">
					<div className="space-y-3">
						...
						<p className="text-base text-background/60 font-light max-w-xs leading-relaxed">
							The developer-first API for detecting disposable and
							temporary email addresses at scale.
						</p>
					</div>
